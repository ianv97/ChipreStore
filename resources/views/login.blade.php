...
<style>
    ...
    @media (min-width: 1601px){
        body{
            background: url(../img/bg/loginbg1920.jpg) no-repeat center center fixed;
    ...
    @media (max-width: 1600px){
        body{
            background: url(../img/bg/loginbg1600.jpg) no-repeat center center fixed;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
    ...
    @media (max-width: 1280px){
        body{
            background: url(../img/bg/loginbg1280.jpg) no-repeat center center fixed;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
    ...
    @media (max-width: 1024px){
        body{
            background: url(../img/bg/loginbg1024.jpg) no-repeat center center fixed;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
    ...
    @media (max-width: 800px){
        body{
            background: url(../img/bg/loginbg800.jpg) no-repeat center center fixed;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
    ...
    @media (max-width: 512px){
        body{
            background: url(../img/bg/loginbg512.jpg) no-repeat center center fixed;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -o-background-size: cover;
            background-size: cover;
