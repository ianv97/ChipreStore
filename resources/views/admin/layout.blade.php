      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="../../../templateAdmin/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="../../../templateAdmin/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../../../templateAdmin/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
