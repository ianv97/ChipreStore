...
CREATE TABLE `categories_products` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `categories_products_category_id_foreign_idx` (`category_id`),
...
INSERT INTO `customers` VALUES (1,'ianalexisnet@hotmail.com','$2y$10$LHaR5JNQSnHTfUvz2pDufuMbpvyn2zRVRGtWMPZZOELOYrrE4er0O','Vaernet, Ian',429,'García Merou 456','3624360065','2019-02-23 15:51:23','2019-02-23 15:51:23');
...
CREATE TABLE `sale_lines` (
  ...
  `waist_id` int(10) unsigned DEFAULT NULL,
